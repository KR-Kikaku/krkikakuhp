...
import ContactThread from '@/components/admin/ContactThread';
...
import { Eye, Trash2, Send, CheckCircle, X } from 'lucide-react';
...
export default function AdminContacts() {
  ...
  return (
    <AdminLayout currentPage="contacts">
      <AdminPageHeader
        title="お問い合わせ管理"
        description={`受信: ${contacts.length}件 | 未読: ${unreadCount}件 | 未返信: ${needsReplyCount}件`}
      />
      ...
      <div className="space-y-4">
        ...
        {contacts.length === 0 && <EmptyState message="お問い合わせがありません" />}
      </div>
        ...
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {selectedContact && (
            <div className="space-y-4 py-4">
              ...
              <ContactThread contact={selectedContact} />
